    ...
    <div class="flex-1 flex flex-col gap-2">
      ...
      <div class="flex flex-col gap-3">
        <div class="flex flex-col rounded-lg">
          <h1 class="text-base-content mb-1 text-center">SOCIAL</h1>

          <a
            href="https://instagram.com/4b_49_4b_4b_55"
            target="_blank"
        ...
        <!-- Support -->
        <div class="flex flex-col rounded-lg">
          <h1 class="text-base-content mb-1 text-center">SUPPORT</h1>
          <a
            href="/terms.html"
            target="_blank"
            class="flex justify-between items-center no-underline"
          ...
          <div class="divider m-0"></div>
          <a
            href="mailto:lovemelong@protonmail.com"
            class="flex justify-between items-center no-underline"
          >
            <div>Contact</div>
            <div>
