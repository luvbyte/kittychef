<script setup lang="ts">
  ...
  const downloadText = () => {
    ...
    link.href = url;
    link.download = "text.txt"; // change filename if needed
...
<template>
  ...
  >
    ...
    <div v-if="text.length > 0" class="flex items-center gap-1">
      <span class="pl-2 rounded whitespace-nowrap">
        <strong>{{ encoding }}</strong>
      </span>

      <button @click="downloadText" class="flex items-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
        ...
        >
          ...
          >
            <path
              d="M2.5 13.5v-7h19v7c0 3.771 0 5.657-1.172 6.828S17.272 21.5 13.5 21.5h-3c-3.771 0-5.657 0-6.828-1.172S2.5 17.271 2.5 13.5m0-7l.6-.8c1.178-1.57 1.767-2.355 2.611-2.778C6.556 2.5 7.537 2.5 9.5 2.5h5c1.963 0 2.944 0 3.789.422c.845.423 1.433 1.208 2.611 2.778l.6.8"
            />
